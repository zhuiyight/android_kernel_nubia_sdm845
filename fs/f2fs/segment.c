...
skip:
        ...
        if(sbi->trim_stat == NUBIA_F2FS_EXIT_TRIM){
            f2fs_warn(sbi, "input trim stat is %d, must exit!", sbi->trim_stat);
            break;
        }
#endif
...
int f2fs_trim_fs(struct f2fs_sb_info *sbi, struct fstrim_range *range)
{
    ...
    f2fs_warn(sbi, "trimmed start, trim_stat is %d.", sbi->trim_stat);
#endif
    ...
    f2fs_warn(sbi, "trimmed is %lld, trim_stat is %d.",
